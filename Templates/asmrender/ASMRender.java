...
public class ASMRender 
{
    ...
    public static void markBlock(String[] text, float x, float y, float z, Color color, float alpha)
    {
        ...
        int lineHeight = 10;
        int textWidth = text.length * lineHeight;
        ...
        float scale = 1f/(3f+textWidth);
        GL11.glScalef(scale, scale, scale);
        GL11.glRotatef(90f, 1f, 0f, 0f);
        
        for(int i = 0; i < text.length; i++) {
            fontRenderer.drawString(text[i], 2.0f, 1.0f + i * lineHeight, 0xffffffff, false);
        }
